...
Original file is located at
    https://colab.research.google.com/drive/1z-o_iGcpWegVzqdadbGejNeBmsureCmg
"""
...
def city_analysis(city_name):
    prompt=f"Provide a detailed analysis of {city_name} including:\n1. Crime index and safety statistics\n2. Accident rates and traffic safety information\n3. Oberall safety assessment\n\Analysis:"
    return generate_response(prompt, max_length=1000)

def citizen_interaction(query):
  promt=f"As a givernment assistant, provide accurate and helpful information about the following citizen query related to public services, gobernment policies, or civic issues:\n\nQuary: {query}\nReponse:"
  return generate_response(prompt, max_length=1000)
